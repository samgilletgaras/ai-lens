...
Guidance for AI Assistants when working in this repository.
...
- This `AGENTS.md` — update the constraints, commands, styling tokens, or doc
  pointers above whenever they drift.

Stale docs cause incorrect code generation. If a change makes any statement in
`docs/` or `AGENTS.md` wrong, fixing it is part of finishing the change.
